...
using Track_Meet.Models;

namespace Track_Meet.Controllers
{
    public class RunnersController : Controller
    {
        private readonly RunnerContext _context;

        public RunnersController(RunnerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Gender,Event,Result")] Runner runner)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Gender,Event,Result")] Runner runner)
        {
            if (id != runner.Id)
            {
                return NotFound();
